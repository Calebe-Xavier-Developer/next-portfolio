    ...
    <main className="w-screen h-screen relative">
      <div className="flex items-center w-full h-full bg-cover bg-center" style={{backgroundImage: "url(/main-bg.webp"}}>
        <div className="pl-20 md:pl-40 pb-56 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px]">
          ...
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid, natus quos vero quia repellendus tenetur, beatae eos earum quod necessitatibus voluptatum laudantium vel consequuntur perferendis. Eos pariatur aliquid repudiandae eveniet!
          </p>
          <div className="flex-col md:flex-row hidden md:flex gap-5">
            ...
            <Link href="/my-projects"  className="rounded-[20px] group relative bg-blue-500 hover:bg-blue-400 px-5 py-3 text-lg text-white max-w-[200px]">
              <div className="absolute rounded-[20px] z-[1] bg-white inseat-0 opacity-0 group-hover:opacity-20" />
              My projects
            </Link>
